...
import edu.pitt.math.hol_ssreflect.core.printer.Printer;
import edu.pitt.math.hol_ssreflect.core.printer.TermPrinterData;
import edu.pitt.math.hol_ssreflect.core.printer.SelectionTree;
import edu.pitt.math.hol_ssreflect.gui.CamlObjectComponent;
import edu.pitt.math.hol_ssreflect.gui.CamlObjectTable;
...
//			tms[i] = Parser.parseTerm(strs[i % strs.length]);
		...
		edu.pitt.math.hol_ssreflect.gui.CamlObjectList list = new edu.pitt.math.hol_ssreflect.gui.CamlObjectList();
		for (int i = 0; i < tms.length; i++)
			list.add(tms[i]);
